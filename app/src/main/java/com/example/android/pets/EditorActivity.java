...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public final static int EXISTING_PET_LOADER = 0;
    ...
    /**
     * dbPetHelper to store values into database
     */
    ...
    private void savePet() {
        ...
        if (mCurrentPetUri == null) {
            ...
            if (newUri == null) {
                Toast.makeText(this, "Insert was unsuccessful", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(this, "Insert was successful", Toast.LENGTH_SHORT).show();
            }
        } else {
    ...
    public Loader onCreateLoader(int id, Bundle args) {
        ...
        return new CursorLoader(this, mCurrentPetUri, mProjection, null, null, null);
    }
